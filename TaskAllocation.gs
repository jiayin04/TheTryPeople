function onOpen() {
  ...
  ui.createMenu('Task Management')
    .addItem('Initialize Task Management', 'initializeTaskManagement')
    .addItem('Log Progress', 'openWebApp')
    .addItem('Generate Progress Report', 'generateProgressReport')
    .addToUi();
}
...
function openWebApp() {
  var html = HtmlService.createHtmlOutput('<html><script>'
    + 'window.open("https://script.google.com/macros/s/AKfycbz9r48gRWtBtCnhg1Vgl8A7xoZz2Th-7A9SqCApdOxE/dev");'
